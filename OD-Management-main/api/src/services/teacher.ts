...
export class TeacherService {
  ...
  async createTeacher(data: {
    ...
    return await prisma.$transaction(async (tx) => {
      ...
      if (existingUser) {
        // If there's already a teacher linked to that user, bail out with a clear error
        ...
        // Update the existing user with provided details (password, phone, name) and set role to TEACHER
        ...
        // Create teacher linked to the existing user
